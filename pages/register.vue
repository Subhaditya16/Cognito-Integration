<template>
  <div class="grid place-items-center h-screen max-w-md mx-auto pt-6">
    <div>
      ...
      <div v-if="!$auth.isAuthenticated">
        ...
        <!-- <div>
          <button v-on:click="google" class="button--green">Sign In With Google</button>
          <button v-on:click="google" class="button--green">Sign In With Facebook</button>
        </div> -->
      </div>
